...
/**
 * set_alias - this function will either set an existing alias 'name' with
...
/**
 * replace_aliases - this Goes through the arguments and replace every
